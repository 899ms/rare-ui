export const SITE_URL = "https://rareui.com";

export const SITE_NAME = "Rare UI";

export const SITE_ALT_NAMES = ["RareUI", "Rare UI Components", "rareui.com"];

export const SITE_TAGLINE = "Rare UI — Rare Animated React Components";
